...
public class OrderBasedCrossoverTest {
    ...
    public OrderBasedCrossoverTest() {
        this.orderBasedCrossover = new OrderBasedCrossover();
        this.orderBasedCrossover.setRandom(new Random(5));
    }

    @Test
    public void testCrossover() {
        int[] expected1 = new int[] {9, 3, 2, 4, 5, 8, 7, 6, 1};
        int[] expected2 = new int[] {3, 2, 4, 6, 7, 8, 9, 5, 1};

        Individual parent1 = new Individual( new int[]{1, 3, 2, 4, 5, 8, 7, 6, 9});
        Individual parent2 = new Individual( new int[]{3, 2, 4, 6, 7, 8, 9, 5, 1});

        Individual child1 = orderBasedCrossover.cross(parent1, parent2);
        Individual child2 = orderBasedCrossover.cross(parent2, parent1);
